...
import im.zego.video.talk.databinding.SportShootBinding;
...
public class SportShootUI extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.sport_shoot);
...
//                binding.roomConnectState.setText(getString(R.string.room_unconnect));
            ...
            if (errorCode != 0) {
                Toast.makeText(SportShootUI.this, String.format("login room fail, errorCode: %d", errorCode), Toast.LENGTH_LONG).show();
            }
